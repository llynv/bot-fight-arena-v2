...
This project is indexed by GitNexus as **bot-fight-arena-v2** (728 symbols, 1709 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/bot-fight-arena-v2/process/{processName}` — trace the full execution flow step by step
